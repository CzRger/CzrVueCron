<template>
  <div class="minute">
    <div style="text-align: left">允许的通配符[, - * /]</div>
    ...
    <div class="item">
      ...
      <div class="content">
        周期从
        <input v-model="cycleVal_1" type="number" min="0" max="59" step="1"/>
        -
        <input v-model="cycleVal_2" type="number" min="0" max="59" step="1"/>
        分钟
      </div>
    </div>
    <div class="item">
      ...
      <div class="content">
        从
        <input v-model="toVal_1" type="number" min="0" max="59" step="1"/>
        分钟开始，每
        <input v-model="toVal_2" type="number" min="0" max="59" step="1"/>
        分钟执行一次
      </div>
    </div>
    <div class="item">
    ...
    data() {
      return {
        ...
        designNodes: [
          ...
          {val: 32, label: 32, active: false},
          {val: 33, label: 33, active: false},
          {val: 34, label: 34, active: false},
          {val: 35, label: 35, active: false},
          {val: 36, label: 36, active: false},
          {val: 37, label: 37, active: false},
          {val: 38, label: 38, active: false},
          {val: 39, label: 39, active: false},
          {val: 40, label: 40, active: false},
          {val: 41, label: 41, active: false},
          {val: 42, label: 42, active: false},
          {val: 43, label: 43, active: false},
          {val: 44, label: 44, active: false},
          {val: 45, label: 45, active: false},
          {val: 46, label: 46, active: false},
          {val: 47, label: 47, active: false},
          {val: 48, label: 48, active: false},
          {val: 49, label: 49, active: false},
          {val: 50, label: 50, active: false},
          {val: 51, label: 51, active: false},
          {val: 52, label: 52, active: false},
          {val: 53, label: 53, active: false},
          {val: 54, label: 54, active: false},
          {val: 55, label: 55, active: false},
          {val: 56, label: 56, active: false},
          {val: 57, label: 57, active: false},
          {val: 58, label: 58, active: false},
          {val: 59, label: 59, active: false},
        ],
        designList: []
      }
    },
    ...
    watch: {
      val(n) {
        if (n === '*') {
          ...
          this.toVal_2 = temp[1]
          this.mode = 3
        } else if (n.includes(',') || new RegExp(/(^([1-5][0-9]{1})$)|^[0-9]{1}$/).test(n)) {
          const temp = n.split(',')
      ...
      cycleVal_1(n, o) {
        if (n === 'e') {
          ...
          this.cycleVal_1 = this.format(0, 59, n)
        }
      },
      cycleVal_2(n, o) {
        if (n === 'e') {
          ...
          this.cycleVal_2 = this.format(0, 59, n)
        }
      },
      toVal_1(n, o) {
        if (n === 'e') {
          ...
          this.toVal_1 = this.format(0, 59, n)
        }
      },
      toVal_2(n, o) {
        if (n === 'e') {
          ...
          this.toVal_2 = this.format(0, 59, n)
        }
      }
    },
    methods: {

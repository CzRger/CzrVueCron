<template>
  <div class="month">
    ...
    <div class="item">
      ...
      <div class="content">
        周期从
        <input v-model="cycleVal_1" type="number" min="1" max="12" step="1"/>
        -
        <input v-model="cycleVal_2" type="number" min="1" max="12" step="1"/>
        月
      </div>
    </div>
    <div class="item">
      ...
      <div class="content">
        从
        <input v-model="toVal_1" type="number" min="1" max="12" step="1"/>
        月开始，每
        <input v-model="toVal_2" type="number" min="1" max="12" step="1"/>
        月执行一次
      </div>
    </div>
    <div class="item">
    ...
    watch: {
      val(n) {
        if (n === '*') {
          ...
          this.toVal_2 = temp[1]
          this.mode = 3
        } else if (n.includes(',') || new RegExp(/(^[1-9]{1}$)|(^[1][0-2]{1}$)/).test(n)) {
          const temp = n.split(',')
      ...
      cycleVal_1(n, o) {
        if (n === 'e') {
          ...
          this.cycleVal_1 = this.format(1, 12, n)
        }
      },
      cycleVal_2(n, o) {
        if (n === 'e') {
          ...
          this.cycleVal_2 = this.format(1, 12, n)
        }
      },
      toVal_1(n, o) {
        if (n === 'e') {
          ...
          this.toVal_1 = this.format(1, 12, n)
        }
      },
      toVal_2(n, o) {
        if (n === 'e') {
          ...
          this.toVal_2 = this.format(1, 12, n)
        }
      }
    },
    methods: {
